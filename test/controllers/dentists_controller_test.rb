...
class DentistsControllerTest < ActionController::TestCase
  ...
  test "should create dentist" do
    assert_difference('Dentist.count') do
      post :create, dentist: { email: @dentist.email, first_name: @dentist.first_name, last_name: @dentist.last_name, phone: @dentist.phone }
    end
  ...
  test "should update dentist" do
    patch :update, id: @dentist, dentist: { email: @dentist.email, first_name: @dentist.first_name, last_name: @dentist.last_name, phone: @dentist.phone }
    assert_redirected_to dentist_path(assigns(:dentist))
  end
